...
1. Navigate to **Virtual Private Cloud Console** and select **Subnets**
...
#### Pre-requisite
- Ensure you have Putty installed on local machine (You can download from: [here]https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html)
